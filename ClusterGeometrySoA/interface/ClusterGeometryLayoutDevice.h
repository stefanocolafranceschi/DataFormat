#ifndef DataFormats_ClusterGeometrySoA_interface_ClusterGeometryDevice_h
#define DataFormats_ClusterGeometrySoA_interface_ClusterGeometryDevice_h
...
class ClusterGeometryDevice : public PortableDeviceCollection<ClusterGeometrySoA, TDev> {
public:
  // Constructor that initializes the collection with the size and queue (for device memory)
  template <typename TQueue>
  explicit ClusterGeometryDevice(size_t nClusters, TQueue queue)
      : PortableDeviceCollection<ClusterGeometrySoA, TDev>(nClusters, queue) {}

  // Constructor that initializes the collection with the size and device reference
  explicit ClusterGeometryDevice(size_t nClusters, TDev const& device)
      : PortableDeviceCollection<ClusterGeometrySoA, TDev>(nClusters, device) {}
...
#endif  // DataFormats_ClusterGeometrySoA_interface_ClusterGeometryDevice_h
